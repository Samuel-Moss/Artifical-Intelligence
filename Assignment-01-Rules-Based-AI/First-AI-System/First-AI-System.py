...
def main():
    ...
    # This code, generated by ChatGPT, fills the predicted grade column up with predicted grades by following through the created rules
    ...
    # This code, generated by ChatGPT, creates a Confusion Matrix based on the rows 'Predicted_Grade' and 'Assumed_Grade'. It also create an actual total, too clearly see the the bias in predictions.
    ...
    # The code below is generated by ChatGPT and ends the time and memory tracking, to finalise hardware memory metrics.  However, it was not used in the research paper as a metric to compare.
